<section class="px-4 py-3 my-5 text-white footer-section px-md-5 justify-content-between">
  <footer>
    <div class="container-fluid">
      <img src="{{ asset('assets/image/image (6).png') }}" alt="" class="pb-3 mx-auto mb-3 img-fluid d-block" />
      <div class="flex-wrap px-3 text-center row gy-4 text-md-start d-flex justify-content-between px-md-4">
        <!-- Contact Section -->
        <div class="col-12 col-md-6 col-lg-2">
          ...
          <p class="icon-social">
            <i class="bi bi-telephone-fill"></i> (Osogbo) +234 8081555652 <br>
            <i class="bi bi-telephone-fill"></i> (Ejigbo) +234 8165277994 <br>
            <i class="bi bi-telephone-fill"></i> (Abidjan) +225 0566331133 <br>
            </p>
            <p class="icon-social">
